...
function App() {
  ...
  // 1. NUOVO STATO: Memorizza la categoria scelta (di base è "Tutte")
    ...
    <Router>
      <div style={{ display: 'flex', flexDirection: 'column', minHeight: '100vh', backgroundColor: isDarkMode ? '#111827' : '#F9FAFB' }}>
        ...
        <nav style={{ 
          ...
          display: 'flex', 
          flexWrap: 'wrap', // Permette agli elementi di andare a capo su mobile
          justifyContent: 'space-between', 
          alignItems: 'center', 
          position: 'sticky', 
          top: 0, 
          ...
          gap: '15px' // Spazio tra le righe se vanno a capo su mobile
        }}>
          ...
          {/* 2. I NUOVI BOTTONI DELLE CATEGORIE (Al centro) */}
          <div style={{ display: 'flex', gap: '10px', overflowX: 'auto', paddingBottom: '5px' }}>
            <button 
              onClick={() => setCategoriaAttiva('Tutte')}
              style={{
                padding: '8px 16px', fontSize: '16px', fontWeight: '600', cursor: 'pointer', borderRadius: '8px', border: 'none',
                background: categoriaAttiva === 'Tutte' ? '#FF6600' : (isDarkMode ? '#374151' : '#E5E7EB'),
                color: categoriaAttiva === 'Tutte' ? '#FFF' : (isDarkMode ? '#FFF' : '#374151'),
                transition: 'all 0.2s'
              }}
            >
              Tutte
            ...
            <button 
              ...
              style={{
                padding: '8px 16px', fontSize: '16px', fontWeight: '600', cursor: 'pointer', borderRadius: '8px', border: 'none',
                background: categoriaAttiva === 'Pesca' ? '#FF6600' : (isDarkMode ? '#374151' : '#E5E7EB'),
                color: categoriaAttiva === 'Pesca' ? '#FFF' : (isDarkMode ? '#FFF' : '#374151'),
                transition: 'all 0.2s'
              }}
            >
              🎣 Pesca
            ...
            <button 
              ...
              style={{
                padding: '8px 16px', fontSize: '16px', fontWeight: '600', cursor: 'pointer', borderRadius: '8px', border: 'none',
                background: categoriaAttiva === 'Acquario' ? '#FF6600' : (isDarkMode ? '#374151' : '#E5E7EB'),
                color: categoriaAttiva === 'Acquario' ? '#FFF' : (isDarkMode ? '#FFF' : '#374151'),
                transition: 'all 0.2s'
              }}
            >
              🐠 Acquari
          ...
          {/* ICONE SOCIAL E DARK MODE (A destra) */}
        ...
        <div style={{ flex: 1 }}>
          <Routes>
            {/* 3. COMUNICAZIONE: Passo "categoriaAttiva" alla Home */}
            <Route path="/" element={<Home isDarkMode={isDarkMode} categoriaAttiva={categoriaAttiva} searchInput={searchInput} />} />
